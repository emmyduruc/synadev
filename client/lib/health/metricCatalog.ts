...
export const HEALTH_METRIC_LABEL_KEY: Record<HealthMetricKey, string> = {
  ...
  [HEALTH_METRIC_KEY.nightHeartRate]: 'health_metric_night_heart_rate',
  ...
  [HEALTH_METRIC_KEY.deepSleep]: 'health_metric_deep_sleep',
  [HEALTH_METRIC_KEY.remSleep]: 'health_metric_rem_sleep',
  [HEALTH_METRIC_KEY.lightSleep]: 'health_metric_light_sleep',
};
