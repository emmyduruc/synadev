...
export type MenopauseScaleBannerProps = {
  onPress?: () => void;
  onDismiss: () => void;
};

export const MenopauseScaleBanner = ({
  onPress,
  onDismiss,
}: MenopauseScaleBannerProps) => {
      ...
      <TouchableOpacity accessibilityRole="button" onPress={onPress}>
        <Box
          ...
          <Box
            align="center"
            justify="center"
            className="h-12 w-12 rounded-full border border-dusty-rose bg-dusty-rose-light">
            <SymbolView
              name={{
